...
//#include <uart.c>
//Global Variable
unsigned char data_transmit[107],data_receive[60] ,transmit_enable=0,receive_enable=1,SWITCH[8]="$SWITCH",switch_num=0,transmit_check=0;
unsigned char address[39]="resetpratham";
unsigned char data[13]="resetpratham";
unsigned int pkt_length=48,check=0;
int transmitFlag = 0;
volatile unsigned int CmdRxd = 0;
volatile char FLAG;
